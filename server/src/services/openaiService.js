...
export const getFlashcardsFromOpenAI = async (text) => {
  const prompt = `Create multiples of 3 number of study flashcards from the following text. Each flashcard should be in JSON format with "question" and "answer".
  Text: ${text}
  Example output:
  [
